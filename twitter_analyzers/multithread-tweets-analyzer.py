...
def slaveTweetsAnalyzer(consumer_key, consumer_secret, access_token, access_token_secret):
    ...
    while have_user:
        ...
        userId = docList[0]["user_id"]
        print("USER = " + docList[0]["user_id"])
        ...
        usersDB.update_one({"user_id": userId},
    ...
    print(
        "\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n")
    print("NO MORE USERS.  END THREAD")
...
def master():
    ...
    with open('./twitter_credentials.csv') as csv_file:
        ...
        for row in csv_reader:
            if line_count == 0:
                # CSV COLUMNS : consumer_key - consumer_secret - access_token - access_token_secret
                # print(f'CSV COLUMNS :  {"     ".join(row)}')
                line_count += 1
            else:
                # STARTING THE THREADS
                print("TH", line_count, " - ", row[0], " ", row[1], " ", row[2], " ", row[3])
                thread = threading.Thread(target=slaveTweetsAnalyzer, args=(row[0], row[1], row[2], row[3],),
                                          daemon=True)
